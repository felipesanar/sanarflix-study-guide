-- ============================================================
-- 1) announcements.prioridade — normalização de vocabulário
-- ============================================================
BEGIN;
...
-- ============================================================
-- 2) storage policy p/ atendimento + índices
-- ============================================================
    ...
    'attention', jsonb_build_object(
      ...
      'import_batches_falha_7d', jsonb_build_object(
        ...
        'rows', COALESCE((
          ...
          FROM (
            SELECT b.id, b.created_at, b.status, b.failed_count, b.total_count, sa.nome AS simulado_nome
            FROM public.admin_import_batches b
