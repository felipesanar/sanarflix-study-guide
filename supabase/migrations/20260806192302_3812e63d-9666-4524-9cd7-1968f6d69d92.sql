...
REVOKE ALL ON FUNCTION public.get_gestor_detalhamento(uuid, text, uuid[]) FROM PUBLIC;
REVOKE ALL ON FUNCTION public.get_gestor_detalhamento(uuid, text, uuid[]) FROM anon;
GRANT EXECUTE ON FUNCTION public.get_gestor_detalhamento(uuid, text, uuid[]) TO authenticated;
GRANT EXECUTE ON FUNCTION public.get_gestor_detalhamento(uuid, text, uuid[]) TO service_role;
...
REVOKE ALL ON FUNCTION public.get_gestor_questoes(uuid, uuid, integer, integer, text, text) FROM PUBLIC;
REVOKE ALL ON FUNCTION public.get_gestor_questoes(uuid, uuid, integer, integer, text, text) FROM anon;
GRANT EXECUTE ON FUNCTION public.get_gestor_questoes(uuid, uuid, integer, integer, text, text) TO authenticated;
GRANT EXECUTE ON FUNCTION public.get_gestor_questoes(uuid, uuid, integer, integer, text, text) TO service_role;