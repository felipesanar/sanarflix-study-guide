...
-- Adiciona o parâmetro p_grupo (filtro por grupo de evolução) a get_gestor_alunos,
-- correspondente ao commit 44f5af67 do front-end ("Visão de Alunos: filtro por
-- grupo de evolução na tabela nominal").
