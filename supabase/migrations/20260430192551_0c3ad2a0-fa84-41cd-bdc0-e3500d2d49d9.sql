-- Permitir gestor_formal abrir Desempenho Institucional (sem entrar nas agregações)
...
BEGIN
  ...
  IF NOT (
    ...
    RAISE EXCEPTION 'Access denied: requires admin, professor, b2b_partner, gestor or gestor_formal role';
  END IF;
