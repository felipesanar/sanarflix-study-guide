...
-- 1. Add semestre_updated_at column
ALTER TABLE public.users
  ADD COLUMN IF NOT EXISTS semestre_updated_at timestamptz DEFAULT NULL;

-- 2. Replace validate_user_update trigger to enforce 60-day cooldown
