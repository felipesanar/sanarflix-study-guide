...
export { TRACO } from './rotulos';
import { TRACO } from './rotulos';
...
/**
 * `rotuloSituacao` e `rotuloGrupo` moraram aqui até a centralização de rótulos
 * — agora vivem em `./rotulos`, reexportadas para não quebrar quem já importa
 * de `formatters`.
 */
export { rotuloSituacao, rotuloGrupo } from './rotulos';
