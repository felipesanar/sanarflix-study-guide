  ...
  return (
    ...
    >
      <Sidebar
        ...
        className={`transition-all duration-500 ease-out bg-sidebar text-sidebar-foreground border-r border-border [--sidebar-width:16rem] md:[--sidebar-width:17rem] lg:[--sidebar-width:18rem] xl:[--sidebar-width:20rem]`}
        collapsible="icon"
      >
